                    ...
                    <div class="card-body">
                        ...
                        <div class="container">
                            ...
                            <div class="card shadow-sm border-0">
                                <div class="card-body">
                                    <h4 class="font-weight-bold">Numero de pedido</h4>
                                    <h6>#00000</h6>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h5 class="card-title font-weight-bold">Nombre del Cliente</h5>
                                            <h6 class="card-subtitle mb-2 ">Restaurante Ejemplo</h6>
                                        </div>
                                        <div class="col-sm-6">
                                            <h5 class="card-title font-weight-bold">Compra</h5>
                                            <h6 class="">Pasta Larga</h6>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                            <h5 class="card-title font-weight-bold">Costo Unitario Total</h5>
                                            <h6 class="">₡2.450.25</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <a href="" class="border-0 shadow-sm btn btn-block btn-outline-dark">Actualizar
                                informacion</a>
                        </div>
