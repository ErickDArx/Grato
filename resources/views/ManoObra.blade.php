...
<head>
  ...
  <script src="/Grato/resources/js/ManoObra.js"></script>
  <!-- jquery & iScroll -->
...
<body class="drawer drawer--left drawer--sidebar" style="background-color:#E6E6E6 ;">
  ...
  <main role="main" class="drawer-contents" style="background-color:#E6E6E6 ;">
    ...
    <div class="row mr-2 ml-2 mt-3" id="Lista">
      <div class="col-md-8 mb-2">
        ...
        <div class="shadow m-2 card-body bg-white" style="border-radius: 0.5rem;">
                  ...
                  <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
                    ...
                    <main class="modal__content" id="modal-1-content">
                      <form id="Crear" class="form-group" method="POST" action="{{route('total')}}">
                        ...
                        <input type="number" name="dias_laborales_semana" id="" hidden class="form-control"
                          value="{{$item->dias_laborales_semana}}">
                        <input type="number" name="horas_laborales_dia" id="" hidden class="form-control"
          ...
          <div class="row mt-2">
            <div class="col-sm-6 mt-2">
              <h6 class="m-0 font-weight-bold">Salario por minuto</h6>
            </div>
            <div class="col-sm-6">
              @php
              $total=0;
              ...
              @php
              $total=$item->salario_minuto + $total
              @endphp
          ...
          <form action="{{route('ActualizarLabores',$item->id_labor)}}" method="POST">
            ...
            <div class="m-1 d-flex align-items-center row mb-2">
              ...
              <div class="col-sm-3 mt-2">
                <input type="number" name="dias_laborales_semana" id="" class="form-control"
                  value="{{$item->dias_laborales_semana}}">
              </div>
              <div class="col-sm-3 mt-2">
              ...
              <div class="col-sm-3 mt-2">
                <input type="number" name="horas_laborales_dia" id="" class="form-control"
                  value="{{$item->horas_laborales_dia}}">
              </div>
            </div>
        ...
        <div>
          ...
          <div class="shadow m-2 card-body bg-white" style="border-radius: 0.5rem;">
            ...
            <form action="{{route('ActualizarManoDeObra',$item->id_mano_de_obra)}}" method="POST" id="Opciones">
              @csrf
              @method('PUT')
              ...
              <div class="collapse" id="collapseExample{{$item->id_mano_de_obra}}">
                ...
                <div class="border-bottom mb-2 mt-2 m-1 row d-flex align-items-center">
                  <div class="col-sm-6 mb-2">
                    ...
                    <input name="unidad_medida" class="form-control" type="text" value="{{$item->salario_mensual}}">
                  </div>
                  <div class="col-sm-6 mb-2">
                    <div class="">
                      <h6 class="card-title font-weight-bold mt-1">Salario semanal</h6>
                      <input name="cantidad" readonly class="form-control" type="number"
                ...
                <div class="border-bottom mb-2 mt-2 m-1 row d-flex align-items-center">
                  <div class="col-sm-6 mb-2">
                    ...
                    <input name="costo" class="form-control" readonly type="text" value="{{$item->salario_diario}}">
                  </div>
                  <div class="col-sm-6 mb-2">
                    <h6 class="card-title font-weight-bold mt-1">Salario por hora</h6>
                    <input name="presentacion" class="form-control" readonly type="number"
                ...
                <div class="border-bottom mb-2 mt-2 m-1 row d-flex align-items-center">
                  <div class="col-sm-6 mb-2">
                    ...
                    <input name="precio_um" class="form-control" readonly type="text" value="{{$item->salario_minuto}}">
                  </div>
                </div>
