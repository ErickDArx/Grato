                    ...
                    <div class="d-flex m-1 row align-items-center">
                        <div class="col-sm-12 border-bottom mb-2 ">
                            <div class="row d-flex align-items-center">
                                <div class="col-sm-6">
                                    <h5 class=" font-weight-normal"><i class="fa fa-user-cog mr-2"></i>
                                        {{ $item->nombre_operario }}
                                        {{ $item->apellido_usuario }}</h5>
                                </div>
                                <div class="col-sm-6 text-sm-right">
                                    <h6><i class="text-primary fa fa-clock mr-2 mt-2 mb-2"></i>Creado
                                    ...
                                    <div class="modal__overlay" tabindex="-1" data-micromodal-close>
                                        <div class="modal__container" role="dialog" aria-modal="true"
                                            ...
                                            <main class="modal__content" id="modal-1-content">
                                                <h6 class="col-12 mt-3">Si usted da aceptar, los cambios se van a aplicar
                                                </h6>
                                            </main>
                                            <footer class="modal__footer">
                                                <button type="submit"
                                                    class="col-3 modal__btn modal__btn-primary col-3 mr-1">
                                                    Aceptar
                                                </button>
                                                <button class="modal__btn col-3" data-micromodal-close
                                                    aria-label="Close this dialog window ">Cerrar</button>
