        ...
        <div class="">
            <form id="Crear" action="{{ route('actualizar', auth()->user()->id_usuario) }}" method="post">
                ...
                <div class="row rounded mt-2 m-0 d-flex align-items-center">
                    ...
                    @if ("nombre_usuario" != auth()->user()->nombre_usuario)
                    ...
                    <div class="col-6">
                        <input readonly type="text" class="form-control" name="" id="nombre_usuario"
                            @if(auth()->user()->rol == 1) value="Administrador" @endif />
                    </div>
                    <div class="col-sm-12">
                    ...
                    <div class="modal__overlay" tabindex="-1" data-micromodal-close>
                        <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
                            ...
                            <footer class="modal__footer">
                                <button type="submit" class="modal__btn modal__btn-primary col-3 mr-1" id="EnviarDatos">Aceptar</button>
