...
<body class="slider-hero">
    <div class="text-center">
        <img src="/Grato/resources/media/Logo.png" alt="Logo Sistema Informático Grato Pastas Artesanales"
            style="width: 10rem;margin-bottom: 2rem;margin-top: 2rem;" class="img-fluid position-relative">
    </div>
    <div id="Sesion">
        <form class="col-10 container card-body shadow bg-light"
            ...
            <div class="text-center">
                ...
                <div class="form-group text-left">
                    <label>Usuario</label>
                    <input type="text" class="form-control @error('email') is-invalid @enderror" name="nombre_usuario"
                        value="{{ old('nombre_usuario') }}" id="nombre_usuario" aria-describedby="emailHelp" autofocus
                        required>
                ...
                <button type="submit" class="btn btn-red shadow btn-block border-0 mb-2">Acceder</button>
