    ...
    <nav class="drawer-nav slider-menu" role="navigation">
        <ul class="drawer-menu">
            ...
            <div class="ml-4 mr-4" style="">
                <li>
                    <a class="drawer-menu-item text-white btn m-1 btn-outline-gray" href="{{('Principal') }}"><i
                            class="fa fa-home mr-2 "></i>Menú Principal</a>
                </li>

                <li>
                    <a class="drawer-menu-item text-white  btn btn-outline-gray m-1" href="{{('Perfil') }}"><i
