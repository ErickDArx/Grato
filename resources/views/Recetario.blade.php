            ...
            <div class="col-md-8 mb-2">
                <div class="card shadow" style="border-radius: 0.5rem;">
                    <div class="card-body">
                        ...
                        <div class="container">
                            <div class="row">
                                <h4 class="col-sm-8">Recetario</h4>
                                <div class="justify-content-end row">
                                    <a href="" class="col-sm-12 btn btn-dark">Ingresar Receta</a>
                                </div>
                            ...
                            <div class="card shadow-sm border-0">
                                <div class="card-body">
                                    <h4 class="font-weight-bold">Nombre de la receta</h4>
                                    <h6>Pasta larga</h6>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h5 class="card-title font-weight-bold">Descripcion</h5>
                                            <h6 class="card-subtitle mb-2 ">Se hara un moldeado de la masa...</h6>
                                        </div>
                                        <div class="col-sm-6">
                                            <h5 class="card-title font-weight-bold">Detalles</h5>
                                            <h6 class="">Se haran 3 minutos de reposo a la masa...</h6>
                                        </div>

                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h5 class="card-title font-weight-bold">Tiempo de duracion</h5>
                                            <h6 class="card-subtitle mb-2 ">27 minutos</h6>
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h5 class="card-title font-weight-bold">Ingredientes</h5>
                                            <h6 class="card-subtitle mb-2 ">1. Harina</h6>
                                            <h6 class="card-subtitle mb-2 ">1. Sal</h6>
                                            <h6 class="card-subtitle mb-2 ">1. Tomate</h6>
